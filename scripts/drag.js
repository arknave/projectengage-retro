...
(function($) {
    ...
    function get_potential_drop_targets() {
        ...
        switch(drag_target.block_type()) {
            ...
            case 'int':
            case 'float':
                return socket_targets2(['any', 'number', drag_target.block_type()].join(','));
            case 'any':
                return socket_targets2('any');
            default:
                return socket_targets2(['any', drag_target.block_type()].join(','));
        }
    }
    ...
    function hit_test() {
        ...
        switch(drag_type) {
            case 'trigger':
                ...
                return position_drop_cursor();
            // no flap
            case 'step':
                drag_target_flap = drag_target_flap.children('.flap');
        }
